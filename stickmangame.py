...
class StickFigureSprite(Sprite):
    def __init__(self, game):
        Sprite.__init__(self, game)
        self.images_left = [ PhotoImage(file="1r.gif"), PhotoImage(file="2r.gif"), PhotoImage(file="3r.gif") ]
        self.images_right = [ PhotoImage(file="1.gif"), PhotoImage(file="2.gif"), PhotoImage(file="3.gif") ]
